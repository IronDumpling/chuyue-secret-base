...
const her = { kind: 'blog', category: 'films-shows', type: 'review', slug: 'her-review' } as const
...
describe('buildPageMetadata', () => {
  it('produces canonical, open graph and twitter data with absolute urls', () => {
    ...
    expect(meta.alternates?.canonical).toBe(`${base}/en/blog/films-shows/review/her-review/`)
    expect(meta.openGraph).toMatchObject({
      url: `${base}/en/blog/films-shows/review/her-review/`,
      siteName: 'Chuyue',
      locale: 'en_US',
      publishedTime: '2026-01-04T00:00:00.000Z',
      images: [
        { url: `${base}/share/og/en/blog/films-shows/review/her-review.jpg`, width: 1200, height: 630, alt: 'Her Review' },
      ],
    })
  ...
  it('uses the page language for the url, image and locale', () => {
    ...
    expect(meta.alternates?.canonical).toBe(`${base}/zh/blog/films-shows/review/her-review/`)
    expect(meta.openGraph).toMatchObject({ locale: 'zh_CN' })
    expect((meta.openGraph as any).images[0].url).toBe(`${base}/share/og/zh/blog/films-shows/review/her-review.jpg`)
  })
  ...
  it('lists both languages as alternates, with English as the default', () => {
    ...
    expect(meta.alternates?.languages).toEqual({
      en: `${base}/en/blog/films-shows/review/her-review/`,
      zh: `${base}/zh/blog/films-shows/review/her-review/`,
      'x-default': `${base}/en/blog/films-shows/review/her-review/`,
    })
  })
  ...
  it('only lists languages the post really exists in, and canonicalises a fallback page', () => {
    ...
    expect((meta.openGraph as any).url).toBe(`${base}/zh/blog/films-shows/review/her-review/`)
  })
